...
import net.tier1234.better_deco_building.init.ModBundledTabs;
import net.tier1234.better_deco_building.init.ModCreativeTabs;
import net.tier1234.better_deco_building.mixin.accessor.CreativeModeInventoryScreenAccessor;
import net.tier1234.better_deco_building.mixin.accessor.ScreenAccessor;
...
public class BundledTabSelector {
    private static final ResourceLocation SELECTOR_BAR =
            Constants.id("textures/gui/tab_interface/tab_interface.png");
